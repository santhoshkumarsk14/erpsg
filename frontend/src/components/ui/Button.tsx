...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    secondary: 'bg-gray-200 text-navy hover:bg-gray-300 focus:ring-2 focus:ring-offset-2 focus:ring-gray-500',
    outline: 'border border-primary text-primary hover:bg-primary hover:text-white focus:ring-2 focus:ring-offset-2 focus:ring-primary',
