...
public class PurchaseOrder {
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "registeredAddress", column = @Column(name = "supplier_registered_address")),
        @AttributeOverride(name = "uen", column = @Column(name = "supplier_uen")),
        @AttributeOverride(name = "businessRegNo", column = @Column(name = "supplier_business_reg_no")),
        ...
        @AttributeOverride(name = "gstId", column = @Column(name = "supplier_gst_id")),
        @AttributeOverride(name = "country", column = @Column(name = "supplier_country")),
        @AttributeOverride(name = "vatId", column = @Column(name = "supplier_vat_id"))
    })
    private com.sme.shared.PartyDetails supplierDetails;
    ...
    @OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL)
    @JoinColumn(name = "parentId", referencedColumnName = "id")
    private java.util.List<com.sme.shared.AuditTrailLog> auditTrailLogs;
    ...
    public com.sme.shared.PartyDetails getSupplierDetails() { return supplierDetails; }
    public void setSupplierDetails(com.sme.shared.PartyDetails supplierDetails) { this.supplierDetails = supplierDetails; }
    ...
    public java.util.List<com.sme.shared.AuditTrailLog> getAuditTrailLogs() { return auditTrailLogs; }
    public void setAuditTrailLogs(java.util.List<com.sme.shared.AuditTrailLog> auditTrailLogs) { this.auditTrailLogs = auditTrailLogs; }
